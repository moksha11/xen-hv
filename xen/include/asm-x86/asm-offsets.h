...
#define irq_caps_offset 472 /* offsetof(struct domain, irq_caps) */
#define next_in_list_offset 112 /* offsetof(struct domain, next_in_list) */
#define VCPU_myflag 7424 /* offsetof(struct vcpu, myflag) */
...
#define VCPU_svm_vmcb_pa 6344 /* offsetof(struct vcpu, arch.hvm_vcpu.u.svm.vmcb_pa) */
#define VCPU_svm_vmcb 6336 /* offsetof(struct vcpu, arch.hvm_vcpu.u.svm.vmcb) */
#define VCPU_svm_vmcb_in_sync 6364 /* offsetof(struct vcpu, arch.hvm_vcpu.u.svm.vmcb_in_sync) */

#define VCPU_vmx_launched 6380 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.launched) */
#define VCPU_vmx_realmode 6496 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.vmx_realmode) */
#define VCPU_vmx_emulate 6497 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.vmx_emulate) */
#define VCPU_vm86_seg_mask 6498 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.vm86_segment_mask) */
#define VCPU_hvm_guest_cr2 5928 /* offsetof(struct vcpu, arch.hvm_vcpu.guest_cr[2]) */

#define DOMAIN_is_32bit_pv 4172 /* offsetof(struct domain, arch.is_32bit_pv) */
